    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="gatewayV4App.bookBook.home.createOrEditLabel" v-text="$t('gatewayV4App.bookBook.home.createOrEditLabel')">Create or edit a Book</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('gatewayV4App.bookBook.author')" for="book-author">Author</label>
                        <input type="text" class="form-control" name="author" id="book-author"
                            :class="{'valid': !$v.book.author.$invalid, 'invalid': $v.book.author.$invalid }" v-model="$v.book.author.$model"  required/>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('gatewayV4App.bookBook.title')" for="book-title">Title</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('gatewayV4App.bookBook.description')" for="book-description">Description</label>
